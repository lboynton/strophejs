 ...
 *
 *  Parameters:
 *    (String) boshService - The BOSH service URL.
 *    (String) websocketService - The websockets service URL. (Optional)
 *
 *  Returns:
 *    A new Strophe.Connection object.
 */
Strophe.Connection = function (boshService, websocketService)
{
    /* The connected JID. */
    this.jid = "";
    /* the JIDs domain */
	...
	if (window.WebSocket && websocketService) {
		this.protocol = new Strophe.Websocket(websocketService);
	}
	else {
		this.protocol = new Strophe.Bosh(boshService);
	}
...
Strophe.Connection.prototype = {
     ...
     */
    connect: function (jid, pass, callback, args)
    {
        this.jid = jid;
        this.pass = pass;
        ...
        this.protocol.connect(this, args);
    },
